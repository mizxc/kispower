...
(function ($w) {
    ...
    jsMind.screenshot.prototype = {
        ...
        _watermark: function () {
            ...
            ctx.fillStyle = '#f00';
            ctx.font = '24px Verdana,Arial,Helvetica,sans-serif';
            var data = this.jm.get_data()
            var rightText = data.meta.name + '_' + data.meta.version + ' by:'+data.meta.author
            ctx.fillText(rightText, c.width - 5.5, c.height - 2.5);
            ctx.textAlign = 'left';
